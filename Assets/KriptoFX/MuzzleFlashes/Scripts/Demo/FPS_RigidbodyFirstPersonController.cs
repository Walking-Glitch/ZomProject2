...
using UnityEngine;
    ...
    public class FPS_RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public class AdvancedSettings
        {
            ...
            public float shellOffset; //reduce the dimensions by that ratio to avoid getting stuck in wall (a value of 0.1f is nice)
        }
        ...
        FPS_MouseLook mouseLook = new FPS_MouseLook();
